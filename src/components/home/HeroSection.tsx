...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  mainTitle = 'ABS TRAFIKSKOLA',
  subTitle = 'Driving License with Confident',
  buttonText = 'Book Training',
  promotionText = 'KORLEKTION FR.',
  promotionPrice = 'endast 575 kr.',
  promotionSubtext = 'Competitive Price Exceptional Driving Lesson',
    ...
    <div className="relative w-full bg-white px-6 xl:px-0">
      <div className="w-full xl:w-[1320px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-5 gap-8 mt-8 pb-20">
          {heroItems.map(({ icon, title, text }, index) => (
