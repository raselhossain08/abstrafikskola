...
export default function Footer() {
  ...
  const sortedSocialLinks = (footerData?.socialLinks && Array.isArray(footerData.socialLinks) ? footerData.socialLinks : []).sort((a, b) => a.order - b.order);
  const sortedCompanyLinks = (footerData?.companySection?.links && Array.isArray(footerData.companySection.links) ? footerData.companySection.links : []).sort((a, b) => a.order - b.order);
  const sortedContacts = (footerData?.contactsSection?.contacts && Array.isArray(footerData.contactsSection.contacts) ? footerData.contactsSection.contacts : []).sort((a, b) => a.order - b.order);
